        ...
        <main className='max-w-md px-2 mx-auto'>
            ...
            <form>
                ...
                <div className='flex '>
                    ...
                    <button type='button' id='type' value='sale' onClick={onchange} className={`ml-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration-150 ease-in-out w-full ${type === 'sell' ? 'bg-white text-black' : 'bg-slate-600 text-white'}`}>Rent</button>
                </div>
