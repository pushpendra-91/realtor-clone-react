      ...
      <div className="max-w-6xl mx-auto pt-4 space-y-6">
        ...
        {rentListings && rentListings.length > 0 && (
          <div className="m-2 mb-6 ">
            ...
            <Link to="/category/rent">
              <p className="px-3 text-sm text-blue-600 hover:text-blue-800 transition duration-150 ease-in-out">Show more places of rent...</p>
            </Link>
            <ul className="sm:grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        {saleListings && saleListings.length > 0 && (
          <div className="m-2 mb-6 ">
            ...
            <Link to="/category/rent">
              <p className="px-3 text-sm text-blue-600 hover:text-blue-800 transition duration-150 ease-in-out">Show more places of sale...</p>
            </Link>
            <ul className="sm:grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
